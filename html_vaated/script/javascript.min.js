...
a)},500))});$("#districts").bind("change",{url:"random"},querydb);$("#politics-party").bind("change",{url:"random"},querydb);""===g&&(""===f&&""===d)&&$.getJSON("/server/GetVotes",function(a){updateStatisticsTable(a,0)});"https:"!==window.location.protocol&&(b=new WebSocket("ws://veebimaailm.dyndns.info/server/VotesUpdate","echo-protocol"),b.onopen=function(){},b.onmessage=function(){current_local_part=location.href.split("?")[1];console.log(current_local_part);-1!==current_local_part.indexOf("letters")?
$("#search-candidate").keyup():$("#politics-party").change()});b=document.getElementsByTagName("script");a=!1;for(c=0;c<b.length;c++)if(-1!==b[c].src.indexOf("script/votesDownloader.js")){a=!0;break}a||downloadJSAtOnload("script/votesDownloader.js")}else if("kandideerimine.html"===b){$("#districts").bind("change",hideSelectionError);$("#politics-party").bind("change",hideSelectionError);$("#candidate_questionary").submit(valitadeQuestionary);$.getJSON("/server/private/Nominate",function(a){$("#is_voted_text").empty();
"alreadyNominated"===a.result?nominatedBox(a):notNominatedBox()});b=document.getElementsByTagName("script");a=!1;for(c=0;c<b.length;c++)if(-1!==b[c].src.indexOf("script/jquery-ui.min.js")){a=!0;break}a||downloadJSAtOnload("script/jquery-ui.min.js")}""!==g&&$("#politics-party").val(g);""!==f&&$("#districts").val(f);""!==d&&$("#search-candidate").val(d);""!==g?$("#politics-party").change():""!==f?$("#districts").change():""!==d&&$("#search-candidate").keyup();$("#loading").hide();return $("#content").html()}}}
...
function downloadJSAtOnload(a){var b=document.createElement("script");b.src=a;document.body.appendChild(b)};function initialize(){var a={center:new google.maps.LatLng(58.7682,25.266723),zoom:8,mapTypeId:google.maps.MapTypeId.ROADMAP},a=new google.maps.Map(document.getElementById("googleMap"),a);jQuery.ajaxSetup({async:!1});var b=getPartys(),c="";$.getJSON("/server/GetRegions",function(a){c=a.regions});jQuery.ajaxSetup({async:!0});addMarkers(a,b,c);createLegend(a,b)}
...
function createLegend(a,b){var c=document.getElementById("legend");b.forEach(function(a){$("#legend").append('<div><img src="'+a.markerimage.url+'"> '+a.name+"</div>")});a.controls[google.maps.ControlPosition.RIGHT_BOTTOM].push(c)};var timeout=null;
...
function login(){"https:"!==window.location.protocol?window.location.href=window.location.href.replace("http","https"):($.post("/server/private/VerifyLogin",{login:!0},function(a){"success"===a.result?window.location.reload():alert(a.error_code)}),event.preventDefault())};
